...
export function MagicCard({
  ...
  return (
    ...
    >
      <motion.div
        className="bg-border pointer-events-none absolute inset-0 duration-300 group-hover:opacity-100 rounded-md"
        style={{
      ...
      />
      <div className="bg-background absolute inset-px rounded-md" />
      <motion.div
